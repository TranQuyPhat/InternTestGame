...
game.drawPlayer = function () {
  ...
  game.context.drawImage(
    game.playerTexture,
    actualPlayerTile.tileColumn * game.options.playerOptions.tileWidth,
    actualPlayerTile.tileRow * game.options.playerOptions.tileHeight,
    game.options.playerOptions.tileWidth,
    game.options.playerOptions.tileHeight,
    Math.round(
      game.options.canvasWidth / 2 - game.options.playerOptions.tileWidth / 2
    ),
    Math.round(
      game.options.canvasHeight / 2 - game.options.playerOptions.tileHeight / 2
    ),
    game.options.playerOptions.tileWidth,
    game.options.playerOptions.tileHeight
  );
